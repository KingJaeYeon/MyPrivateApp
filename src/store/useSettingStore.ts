  ...
  excel: {
    ...
    prompt: {
      essentialDefs: [
        ...
        { id: 4, label: '제목', column: 'title' },
        { id: 5, label: 'Prompt', column: 'prompt' },
        { id: 6, label: '메모', column: 'memo' },
        { id: 7, label: '갱신일', column: 'updatedAt' },
        { id: 8, label: '생성일', column: 'createdAt' },
      ],
    ...
    english: {
      essentialDefs: [
        ...
        { id: 6, label: '중요도', column: 'isImportant' },
      ],
      order: [1, 2, 3, 4, 5, 6],
      optional: [],
    },
