...
export function JournalSidePanel({ isDeleting }: { isDeleting: boolean }) {
      ...
      <div className={'flex flex-col gap-3'}>
        <div className={'flex flex-col gap-1'}>
          ...
          <Textarea
            ...
            onChange={(e) => setEdit('expressions', { ...edit, text: e.target.value })}
            placeholder="오늘의 영어 일기를 작성하세요..."
          />
        </div>
        ...
        <div className={'flex flex-col gap-1'}>
          ...
          <Textarea
            ...
            placeholder="문법 피드백이나 학습 메모를 작성하세요..."
          />
        </div>

        <div className={'flex flex-col gap-2'}>
          <Label className={'text-sm'}>자동 태깅: 연결된 패턴 ID (쉼표로 구분)</Label>
          <Input
        ...
        <div className={'flex flex-col gap-2'}>
          <Label className={'text-sm'}>자동 태깅: 연결된 동사 ID (쉼표로 구분)</Label>
          <Input
        ...
        <div className={'flex flex-col gap-2'}>
          <Label className={'text-sm'}>자동 태깅: 연결된 개념 ID (쉼표로 구분)</Label>
          <Input
